...
let animalDiv = document.getElementById("bigDiv");
boutton.onclick = function generateAnimal() {
    ...
    animalDiv.innerHTML =
        ...
        "Durée de vie : " + Animal3.dureeDeVie + "<br>" + "<br>" + count
    ...
    if (count == 2) {
        ...
        // boutton.onclick = function generateAnimal2() {
        //     animalDiv.innerHTML =
        //         "<img src='" + Animal4.image + "'>" +
        //         // Animal2.image + "<br>" + "<br>" +
        //         "Nom : " + Animal4.nom + "<br>" + "<br>" +
        //         "Couleur : " + Animal4.couleur + "<br>" + "<br>" +
        //         "Alimentation : " + Animal3.alimentation + "<br>" + "<br>" +
        //         "Taille : " + Animal4.taille + "<br>" + "<br>" +
        //         "Poids : " + Animal4.poids + "<br>" + "<br>" +
        //         "Habitat : " + Animal4.habitat + "<br>" +
        //         "Vitesse : " + Animal4.vitesse + "<br>" + "<br>" +
        //         "Durée de vie : " + Animal4.dureeDeVie + "<br>" + "<br>" + count
        // }
